...
;Compare modulus DeltAX & Deltay due to CX > AX -> x2 > x1
		...
		MOV		WORD[deltaX],CX ;Save deltAX
		POP		CX          ;CX = x2
...
;y = -mx+b 
line32:		
		MOV		WORD[deltaY],DX ;Save deltay
		POP		DX          ;DX = y2

		PUSH	AX          ;Save x2 in stack
		MOV		AX,WORD[deltaX] ;Compare DeltAX with DeltaY
		CMP		AX,WORD[deltaY]
		POP		AX          ;AX = x2
